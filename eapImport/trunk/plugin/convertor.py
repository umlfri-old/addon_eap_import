...
class Convertor:
    ...
    def read(self):
        ...
        for a in sorted_table:
            if a[2] == 0:
                self.aRoot=Element(sorted_table[0][0],
                                   sorted_table[0][2],
    ...
    def write(self):
        ...
        self.aRoot.first_write(self.adapter.project.root,self.adapter.project.metamodel,self.project_diagrams)
        self.aRoot.second_write()
